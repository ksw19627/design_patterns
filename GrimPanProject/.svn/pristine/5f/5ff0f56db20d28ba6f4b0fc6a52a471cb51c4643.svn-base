...
public class GrimShape2SVGTranslator {
	...
	public static String translateShape2SVG(GrimShape gshape){
		...
		Color grimColor = gshape.getGrimColor();
		...
		// style="fill: rgb(255, 128, 64);"
			styleString.append('"');
			styleString.append("fill: "+rgbString(grimColor)+";");
			styleString.append('"');
		}
		else {
		// style="fill: none stroke: rgb(255, 128, 64); stroke-width: 5;"
			styleString.append('"');
			styleString.append("fill: none; ");
			styleString.append("stroke: "+rgbString(grimColor)+"; ");
