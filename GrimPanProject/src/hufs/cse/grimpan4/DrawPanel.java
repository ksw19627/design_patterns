...
public class DrawPanel 
	...
	private static final int MINPOLYDIST = 6;
	...
	private void getPolygonWithCenterNVertex(Point center, Point2D pi){
		...
		polygonPath.lineTo(polyPoints[0].getX(), polyPoints[0].getY());
	...
	private void getSelectedShape(){
		...
		if (selIndex != -1){
			...
			Color scolor = shape.getGrimColor();
			shape.setGrimColor(new Color (scolor.getRed(), scolor.getGreen(), scolor.getBlue(), 127));
		}
	...
	private void endShapeMove(){
		...
		if (selIndex != -1){
			shape = model.shapeList.get(selIndex);
			Color scolor = shape.getGrimColor();
			shape.setGrimColor(new Color (scolor.getRed(), scolor.getGreen(), scolor.getBlue()));
		}
	}
